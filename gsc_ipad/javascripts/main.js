$(document).ready(function() {
    ...
    send_rest_request_throttled = send_rest_request.throttle(events_per_second / 1000.0);
    ...
    $('#mouse-input').mousemove(function(e) {
        e.preventDefault();
        send_rest_request_throttled('/mouse/motion', {x: e.pageX - $(this).offset().left, y:e.pageY - $(this).offset().top});
        return false;
    }).mousedown(function(e) {
        e.preventDefault();
        send_rest_request_throttled('/mouse/press', {x: e.pageX - $(this).offset().left, y:e.pageY - $(this).offset().top, button: e.which});
        return false;
    }).mouseup(function(e) {
        e.preventDefault();
        send_rest_request_throttled('/mouse/release', {x: e.pageX - $(this).offset().left, y:e.pageY - $(this).offset().top, button: e.which});
        return false;
    ...
    $('#mouse-input').bind('touchmove', function(e) {
        ...
        send_rest_request_throttled('/mouse/motion', {x: touch.pageX, y:touch.pageY, button: 1});
    }).bind('touchstart', function(e) {
        e.preventDefault();
        var touch = e.originalEvent.touches[0];
        last_touch_y = touch.pageY;
        last_touch_x = touch.pageX;
        send_rest_request_throttled('/mouse/press', {x: touch.pageX, y:touch.pageY, button: 1});
    }).bind('touchend', function(e) {
        e.preventDefault();
        
        send_rest_request_throttled('/mouse/release', {x: last_touch_x, y:last_touch_y, button: 1});
    });
